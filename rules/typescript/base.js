...
module.exports = {
  ...
  rules: {
    ...
    camelcase: 'off',
    // The `@typescript-eslint/naming-convention` rule allows `leadingUnderscore`
    // and `trailingUnderscore` settings. However, the existing `no-underscore-dangle` rule
    ...
    // The TypeScript version also adds 3 new options,
    // all of which should be set to the same value as the base config
    'comma-dangle': 'off',
